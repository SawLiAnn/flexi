                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="company_name"
                            ...
                            autofocus placeholder="Company name" value="{{ old('company_name', null) }}">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="subdomain"
                            class="form-control{{ $errors->has('subdomain') ? ' is-invalid' : '' }}" required
                            placeholder="Subdomain" value="{{ old('subdomain', null) }}">
