...
// Route::domain('{username}.' . env('APP_URL'))->group(function () {
    Route::domain('{subdomain}.' . env('SESSION_DOMAIN'))->group(function () {
        // Route::get('home2', function ($companyName) {
        //     return 'Home. Company name is ' . $companyName ;
        // });
        Route::resource('home2', 'Home2Controller');
        // Route::get('tenants/website/{tenantID}', 'TeamController@website')->name('teams.website'); 
    
        // Route::resource('book', 'BookController');
        // Route::get('book', 'BookController@index')->name('book.index');
        Route::get('cancel', 'BookController@index')->name('cancel.index');
        
    });
    Route::get('tenants/website/{tenantID}', 'TeamController@website')->name('teams.website'); 
    // Route::get('tenants/website', 'TeamController@website'); 
    Route::get('book', 'BookController@index')->name('book.index');
    
    Route::resource('calendar', 'CalendarController');
    Route::view('datetimepicker', 'datetimepicker');
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::get('tenants/change/{tenantID}', 'TeamController@changeTenant')->name('teams.change');
    // Route::get('tenants/website/{tenantID}', 'TeamController@website')->name('teams.website'); 
